...
4. **Não deixe ele fugir pra zona de conforto.** Se ele tem gap em `context provider` mas quer pular pra `criação de novos componentes` porque é mais confortável, bloqueie. Ele precisa ficar no desconforto até aprender.
